...
import net.project.springboot.service.EmployeeExcelExportService;
...
public class EmployeeController {
	...
	/*
	 * @GetMapping("/viewemployee") public String viewHomePage(Model model) { return
	...
	public ResponseEntity<InputStreamResource> exportToExcel() {
		...
		ByteArrayInputStream bis = EmployeeExcelExportService.exportToExcel(employees);
